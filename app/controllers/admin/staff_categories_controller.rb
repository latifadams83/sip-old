module Admin
  class StaffCategoriesController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @staff_category.save
          format.html { redirect_to admin_staff_categories_path, notice: 'Staff category was successfully created.' }
        else
    ...
    def update
      respond_to do |format|
        if @staff_category.update(staff_category_params)
          format.html { redirect_to admin_staff_categories_path, notice: 'Staff category was successfully updated.' }
        else
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admin_staff_categories_url, notice: 'Staff category was successfully destroyed.' }
      end
    end
