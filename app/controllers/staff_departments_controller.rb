class StaffDepartmentsController < DashboardController
  ...
  def create
    ...
    respond_to do |format|
      if @staff_department.save
        format.html { redirect_to staff_departments_path, notice: 'Staff department was successfully created.' }
        format.js
      else
  ...
  def update
    respond_to do |format|
      if @staff_department.update(staff_department_params)
        format.html { redirect_to staff_departments_path, notice: 'Staff department was successfully updated.' }
        format.js
      else
