...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { active: @calendar.active, end_date: @calendar.end_date, name: @calendar.name, start_date: @calendar.start_date } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { active: @calendar.active, end_date: @calendar.end_date, name: @calendar.name, start_date: @calendar.start_date } }
