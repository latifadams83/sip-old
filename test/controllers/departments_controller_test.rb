...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { category_id: @department.category_id, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { category_id: @department.category_id, name: @department.name } }
