...
class StaffPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create staff_position" do
    assert_difference('StaffPosition.count') do
      post staff_positions_url, params: { staff_position: { name: @staff_position.name, staff_category_id: @staff_position.staff_category_id } }
    end
  ...
  test "should update staff_position" do
    patch staff_position_url(@staff_position), params: { staff_position: { name: @staff_position.name, staff_category_id: @staff_position.staff_category_id } }
